...
#define PWM_OUTPUT_PUMP_LEVEL_1_PWM 250
#define PWM_OUTPUT_PUMP_LEVEL_2_PWM 380
#define PWM_OUTPUT_PUMP_LEVEL_3_PWM 450 // no max value needed, pump is quite powerful
...
#define PWM_OUTPUT_DELTA_T_MINIMUM 8.0f
